const GoogleButton = () => {
  return (
    <div className="w-full flex justify-center">
      <div className="h-[46px] cursor-pointer border border-blue-100 flex items-center gap-2 px-3 rounded-[4px] my-2 bg-[rgba(210,227,256,0.3)]">
        <svg
          x="0px"
          y="0px"
          width="30px"
        ...
        <span className="text-[16px] opacity-80 font-Poppins">
          Sign in with Google
        </span>
      </div>
    </div>
